...
function init() {
    ...
    if ("" != filename && filejson.v) {
        ...
        dataModel.each(function (a) {
            ...
            // for循环开始
            for (e && (e = e.toUpperCase(), a.a("tagname", e), tagsList.contains(e) || tagsList.add(e)),
        ...
        "" != p && ((b = document.createElement("script")).type = "text/javascript", 
            b.text = p, document.body.appendChild(b)),
         //初始化脚本代码
        ...
        // 百度地图展示情况下
        baiduMap ? view.style.backgroundColor = "" : view.style.backgroundColor = dataModel.a("background") || "#FFFFFF", htconfig.autoSize && g2d.fitContent(false, 0), dataModel.each(function (a) {
