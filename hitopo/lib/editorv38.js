        ...
        (currentData = null, tagformPane.v("name", ""), tagformPane.v("tagname", ""), tagformPane.v("tagname1", ""), tagformPane.v("tagname2", ""), tagformPane.v("tagname3", ""), tagformPane.v("tagname4", ""), tagformPane.v("tagname5", ""), tagformPane.v("tagname6", ""), tagformPane.v("tagname7", ""), tagformPane.v("tagname8", ""), tagformPane.v("tagname9", ""), tagformPane.v("vistagname", ""), tagformPane.v("flashtagname", ""), "none" != tagPanel.getView().style.display && (tagPanel.getView().style.display = "none")), t) {
            ...
            if (t.getImage) {
                ...
                if ("string" == typeof a) {
                    ...
                    // var pipe = "管道",
                    //     pipe_properties = window[pipe + '_properties'];                       
                    // a.indexOf(pipe) > 0 && propertyView.addProperties(pipe_properties)
...
function tagconfig_init() {
    tagformPane = new ht.widget.FormPane,
        ...
        tagPanel = new ht.widget.Panel({
            ...
            width: 300,
            contentHeight: 375,
            narrowWhenCollapse: !0,//narrowWhenCollapse 如果为true合并面板时收缩宽度
            content: tagformPane,
            expanded: !1
        }),
...
function browser_createTag(e, t) {
    ...
    "String" != t.type && a.a({ max: t.max, min: t.min }), 
    a
}
...
// g2d右键菜单
    ...
    defaultItem = {
        icon: "images/toolbar/default.gif", toolTip: "默认编辑模式", type: "toggle", action: function () {
            g2d.setEditable(this.selected), palette.sm().cs(), drawing = !1
        }
    },
    ...
    toolbar_options = [
        defaultItem,
        {
            id: "save", icon: "images/toolbar/save.png", toolTip: "保存", action: function () {
                saveScene()
            }
        },
        {
            id: "run", icon: "images/toolbar/run.png", toolTip: "运行", action: function () {
                runCurrent()
            }
        },
        {
            icon: "images/toolbar/zoomIn.gif", toolTip: "放大", action: function () {
                g2d.zoomIn(!0)
            }
        },
        {
            icon: "images/toolbar/zoomOut.gif", toolTip: "缩小", action: function () {
                g2d.zoomOut(!0)
            }
        },
        {
            label: "100%", toolTip: "100%", action: function () {
                g2d.zoomReset(!0)
            }
        },
        {
            label: "0,0", toolTip: "xy坐标恢复", action: function () {
...
// 背景图片
    ...
    showTagsDialog = function (e, t) {
        ...
        serverTags ? callTagsDialog(e, t) : (showLoading(), 
        $.post("server/scada/gettagstable.ashx", {
            rows: _rows,
            page: _scurrentPage
        }, 
        function (a) {
            serverTags = a, _spagecount = a.pagecount, 
            callTagsDialog(e, t), 
            hideLoading()
        }, "json"))
    },
    callTagsDialog = function (e, t) {
        if (serverTags && serverTags.total > 0) {
            ...
            { id: "plug", label: "驱动:", unfocusable: !0, textField: { width: 50 } }, 
            "separator",
            {
                id: "desc",
                label: "描述:",
