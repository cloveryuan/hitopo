...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    levelColors: kvLookup('levelColors', config, dataset, ["#a9d70b", "#f9c802", "#ff0000"], 'array', ','),//a9d70b
    ...
    refreshAnimationTime: kvLookup('refreshAnimationTime', config, dataset, 500),
